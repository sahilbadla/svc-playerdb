...
import com.intuit.playerdb.config.PropertiesConfig;
...
@Component
public class PlayerDBCustomException {
    private static PropertiesConfig propertiesConfig;

    @Autowired
    public PlayerDBCustomException(PropertiesConfig propertiesConfig) {
        PlayerDBCustomException.propertiesConfig = propertiesConfig;
    }
    ...
    private static RuntimeException throwException(ExceptionType exceptionType, String messageTemplate, String... args) {
        ...
        } else if (ExceptionType.ENTITY_BAD_REQUEST.equals(exceptionType)) {
